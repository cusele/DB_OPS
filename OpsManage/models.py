...
class Monitor_mysql(models.Model):
    dbid = models.SmallIntegerField(verbose_name='数据库ID')
    checktime = models.SmallIntegerField(verbose_name='检查时间')
    Aborted_clients = models.SmallIntegerField(verbose_name='由于客户端没有正确关闭连接导致客户端终止而中断的连接数。') 