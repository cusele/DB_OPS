...
BROKER_URL = 'redis://127.0.0.1:26379/4' 
...
REDSI_KWARGS_LPUSH = {"host":'127.0.0.1','port':26379,'db':3}
...
TEMPLATES = [
    {
        ...
        'DIRS': ["/u01/OpsManage/OpsManage/static/",'/u01/OpsManage/OpsManage/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
     '/u01/OpsManage/OpsManage/static/',
    )
