...
## OpsManage功能说明
![image](https://github.com/cusele/ops/blob/master/demo_imgs/opsmanage.png)

## Docker构建OpsManage
[传送门](https://github.com/cusele/ops/wiki/Docker%E6%9E%84%E5%BB%BAOpsManage)

## QQ交流群
![image](https://github.com/cusele/ops/blob/master/demo_imgs/qq_group.png)
...
```
# cd /mnt/
# git clone https://github.com/cusele/ops.git
# cd /mnt/OpsManage/
...
## 部分功能截图:
Ansible部署功能：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/ansible.gif)

代码部署：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/project.gif)

资产管理：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/assets.gif)

计划任务管理：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/crontab.gif)

全局配置：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/config.gif)

用户管理：
![image](https://github.com/cusele/ops/blob/master/demo_imgs/user.gif)
